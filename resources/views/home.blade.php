    ...
    <section data-aos="fade-left" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" class="bg-white">
        ...
        <div class="max-w-5xl px-6 py-16 mx-auto">
            <div class="items-center md:flex md:space-x-6">
                <div class="md:w-1/2">
                    <h3 class="text-2xl font-semibold text-gray-800">{{ $room->hotel->name }} </h3><br>
                    <h4 class="font-light">{{ $room->name }}</h4>

                    <p class="max-w-md mt-4 text-gray-600">Facility Included are: <br>{{ $room->facility }}</p>
                </div>
